...
exports.createToken = exports.userLogin = exports.register = void 0;
...
function register(user) {
    return __awaiter(this, void 0, void 0, function () {
        var userData, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, (0, usersRepository_1.findUser)(user.email)];
                case 1:
                    userData = _a.sent();
                    if (userData) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, usersRepository_1.insertUser)(user)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
