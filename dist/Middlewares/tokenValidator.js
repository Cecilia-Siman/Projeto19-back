...
function tokenValidator(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, secretkey, dados, userInfo, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    dados = jsonwebtoken_1["default"].verify(token, secretkey);
                    return [4 /*yield*/, (0, usersRepository_1.findUser)(dados.email)];
                case 2:
                    userInfo = _a.sent();
                    if (!userInfo) {
